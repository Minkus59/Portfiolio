...
if ($Page=="All") {
    $SelectJpg = $cnx -> prepare("SELECT * FROM ".$Prefix."_Signature_Signer_Jpg WHERE page='1' AND hash=:hash");
...
elseif ($Page=="Last") {
    ...
    $SelectJpg = $cnx -> prepare("SELECT * FROM ".$Prefix."_Signature_Signer_Jpg WHERE page=:page AND hash=:hash");
    $SelectJpg-> BindParam(":hash", $_SESSION['hash2'], PDO::PARAM_STR);
