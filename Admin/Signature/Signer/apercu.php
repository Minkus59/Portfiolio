...
if ($Page=="All") {
    $SelectJpg = $cnx -> prepare("SELECT * FROM ".DB_PREFIX."Signature_Original_Jpg WHERE page='1' AND hash=:hash");
...
elseif ($Page=="Last") {
    $SelectJpg2 = $cnx -> prepare("SELECT * FROM ".DB_PREFIX."Signature_Original_Jpg WHERE hash=:hash");
    ...
    $SelectJpg = $cnx -> prepare("SELECT * FROM ".DB_PREFIX."Signature_Original_Jpg WHERE page=:page AND hash=:hash");
    $SelectJpg-> BindParam(":hash", $_SESSION['hash'], PDO::PARAM_STR);
